  ...
  return [
    {
      ...
      body: [
        ...
        "There is a sobering layer under the optimism. Consolidation, acquisitions, and layoffs are filtering out weaker players, a shift we explain in [Africa's fintech shakeout: the M&A wave, explained](/business/african-fintech-mergers-acquisitions-consolidation). The businesses that survive will need stronger unit economics, cleaner compliance, and a clearer answer to how they make money.",
        "You can see the second wave from different angles across the continent: Tanzania's supervised sandbox at [Tanzania opens its fintech sandbox for a third round](/business/bank-of-tanzania-sandbox-third-cohort), Nigeria's stablecoin trade workaround at [How stablecoins became Nigeria's trade workaround](/business/stablecoins-nigeria-cross-border-trade), and Africa's linked-exchange push at [Africa links 11 stock exchanges as AELP Phase II launches](/business/aelp-phase-2-african-exchanges-linked).",
    ...
    },
    {
      ...
      body: [
        ...
        "This is one practical piece of Africa's wider fintech second wave, where payments, credit, trade rails, and regulation are all maturing at once. Start with the anchor explainer at [African fintech's second wave: from payments to credit](/business/african-fintech-second-wave-credit)."
      ],
      closingLine:
    ...
    },
    {
      ...
      body: [
        ...
        "This story sits inside the wider African fintech second wave explained in [African fintech's second wave: from payments to credit](/business/african-fintech-second-wave-credit). Payments were the first act. The next act is about credit, trade rails, compliance, and the infrastructure that businesses quietly rely on.",
    ...
    },
    {
      ...
      body: [
        ...
        "Still, this is the same pattern we see across African finance: fragmented national systems slowly being stitched into something larger. The second-wave fintech story is about the same thing from a startup angle, explained at [African fintech's second wave: from payments to credit](/business/african-fintech-second-wave-credit). This is the capital-market version."
      ],
      closingLine:
    ...
    },
    {
      ...
      body: [
        ...
        "This is the tougher side of the second-wave fintech shift explained in [African fintech's second wave: from payments to credit](/business/african-fintech-second-wave-credit). Credit, infrastructure, and compliance require scale. Scale often arrives by acquisition.",
