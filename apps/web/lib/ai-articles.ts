  ...
  const articles: Array<Omit<Article, "readTime"> & { readTime?: string }> = [
    {
      ...
      body: [
        ...
        "Update: Anthropic later said the export controls were lifted and that Claude Fable 5 would return worldwide on July 1, 2026. Read the follow-up at [Claude's most powerful model is back, and the saga says a lot about who controls AI](/news/anthropic-redeploys-fable-5)."
      ],
      author: tim,
