  ...
  return [
    ...
    },
    {
      ...
      body: [
        ...
        "HyperDev is not an isolated bright spot. South Africa's venture scene has been showing signs of maturity beyond the headline raise, with pan-African firm Launch Africa Ventures recently returning capital to investors as its first seed fund hit a distributions milestone, a sign that the ecosystem is starting to produce not just startups but returns. Momentum in AI, HR technology, and fintech has continued through the year, and public and corporate investment in local AI and cloud capacity has added to the base, a trend we tracked in Microsoft's South African cloud and AI investment at /news/microsoft-south-africa-cloud-ai-investment. A funding round lands differently when it sits on top of that kind of groundwork.",
        "## The honest caveats",
    ...
    },
    {
      ...
      body: [
        ...
        "## The bigger picture",
        "Read in the round, the Nesa deal is part of a broader flow of capital into African cleantech and climate-focused infrastructure, the same current that has been backing funds and developers across the southern part of the continent, as we noted with the Holocene climate-tech fund at /business/holocene-southern-africa-climate-tech-fund. The pattern is consistent: where public systems fall short, private and blended capital steps in to build the reliable, lower-carbon alternative, one PPA at a time. It is slower and less visible than a product launch, but it is arguably the most durable kind of tech story, the kind that keeps the lights on."
      ],
      closingLine:
    ...
    },
    {
      ...
      body: [
        ...
        "## The bigger pattern",
        "This is the mature phase of a story that began as convenience. Ride-hailing and delivery apps won users by removing uncertainty, then spent years subsidising growth, and are now consolidating into a few large players whose economics have to work without endless discounts, a shift we traced in what changed after the ride-hailing hype faded at /business/what-ride-hailing-apps-changed-after-the-hype-faded. The Uber and Delivery Hero tie-up is that consolidation reaching quick-commerce and food delivery on a global scale. Whether African markets end up with a healthy, competitive delivery sector or a single dominant gatekeeper will be decided less by the deal's press release and more by how firmly regulators from Nairobi to North Africa use the leverage they still hold."
      ],
      closingLine:
