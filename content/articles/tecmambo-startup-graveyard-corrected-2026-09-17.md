...
**Secondary categories:** Kenya, Venture Capital, Business
**Suggested slug:** `kenya-startup-graveyard-twiga-foods-failures`
**Byline:** Tim Humphreys
**H1:** Inside Kenya's "Startup Graveyard": Twiga Joins a KES 93 Billion Wreckage, and One Number Complicates the Story
**SEO title:** Kenya's Startup Graveyard: The Full KES 93 Billion Picture
**Meta description:** Twiga Foods joins Kenya's so-called "startup graveyard," 13 collapsed ventures that raised a combined KES 93 billion in five years. Here's what the pattern actually shows, and what it doesn't.
**Focus keyphrase:** Kenya startup graveyard
**Secondary keywords:** Kenya startup failures, Twiga Foods administration, Copia Global collapse, Gro Intelligence shutdown, Kenya venture capital 2025
**Word count target:** 1,800 to 2,000 words. This is a labeled analysis piece and is explicitly opinion in its conclusions, but every factual claim underneath it is independently sourced below.
**Original value:** Corrects the funding cohort, timeframe, and a serious unsourced allegation from the submitted draft, and adds real documented misconduct (Gro Intelligence's SEC investigation) and a complicating data point (Kenya's 2025 VC dominance) that the original piece omitted.
**Ad eligibility:** Standard business/opinion monetisation.

# Inside Kenya's "Startup Graveyard": Twiga Joins a KES 93 Billion Wreckage, and One Number Complicates the Story

**Quick answer:** This is a labeled analysis piece, not neutral reporting. Twiga Foods' entry into administration this month joins a documented group of 13 once-prominent Kenyan startups that have shut down, entered administration, or liquidated over the past five years, after collectively raising more than KES 93 billion, roughly $718 million. The pattern spans agritech, logistics, e-commerce, and fintech, and most failures trace to the same root cause: asset-heavy, low-margin distribution models built to chase growth metrics rather than unit profitability, then exposed once venture funding tightened. One case, Gro Intelligence, involves a genuine, documented SEC fraud investigation and a wrongful-termination lawsuit, real accountability questions rather than speculation. A complicating fact worth holding alongside all of this: Kenya was still Africa's single largest venture capital destination in 2025, at $984 million, more than any other country on the continent, the same year several of its highest-profile startups from the previous cycle were already failing.
...
- Business Daily Africa, September 2026: Investors lose Sh93bn in Kenya start-up failures
- WeeTracker, September 16, 2026: Kenya Startup Failures Worsened By Flameout Of Once-Celebrated B2B Star
- BitcoinKE, September 2026: Reality Check, Investors Have Lost Over $700 million in Kenyan Startup Failures
- BusinessTechAfrica, August 21, 2026: Kenya's startup market has produced some big funding rounds, it has also produced some expensive failures
- Semafor, June 4, 2024: Kenyan AI data company Gro Intelligence startup shuts down
- CIO Africa, June 3, 2024: Kenyan Startup Gro Intelligence Shuts Down
- TopNews Kenya, September 2026: Kenya's Sh93 Billion startup reckoning, why 13 of its biggest tech bets failed
- Africa: The Big Deal, 2025 annual funding data, as cited in Business Daily Africa reporting
